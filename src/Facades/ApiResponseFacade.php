 ...
 * @method static \Illuminate\Http\JsonResponse badRequest(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse unauthorized(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse paymentRequired(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse forbidden(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse notFound(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse methodNotAllowed(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse notAcceptable(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse proxyAuthenticationRequired(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse requestTimeout(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse conflict(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse gone(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse lengthRequired(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse preconditionFailed(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse requestEntityTooLarge(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse requestUriTooLong(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse unsupportedMediaType(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse requestedRangeNotSatisfiable(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse expectationFailed(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse iAmATeapot(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse misdirectedRequest(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse unprocessableEntity(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse locked(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse failedDependency(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse tooEarly(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse upgradeRequired(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse preconditionRequired(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse tooManyRequests(string $message = '', null|array $error = null)
 * @method static \Illuminate\Http\JsonResponse requestHeaderFieldsTooLarge(string $message = '', null|array $error = null)
